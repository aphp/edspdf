...
@registry.factory.register("simple_text_embedding")
class SimpleTextEmbeddingComponent(BoxEmbeddingComponent):
    """
    ...
    def __init__(
        ...
        name: str = "simple_text_embedding",
    ):
        """
        Parameters
        ----------
    ...
    def preprocess(self, doc: PDFDoc):
        ...
        for page in doc.pages:
            ...
            for i, b in enumerate(page.text_boxes):
