...
@registry.factory.register("box_preprocessor")
class BoxLayoutPreprocessor(TorchComponent[BoxLayoutBatch]):
    """
    ...
    def __init__(
        ...
        name: str = "box_layout_preprocessor",
    ):
    ...
    def preprocess(self, doc: PDFDoc, supervision: bool = False):
        ...
        return {
            ...
            "first_page": [[b.page == 0 for b in p.text_boxes] for p in pages],
            "last_page": [[b.page == last_page for b in p.text_boxes] for p in pages],
        }
